...
const DEFAULT_WORDS = ["NIRAAH", "GROWTH", "STRATEGY", "DIGITAL", "SUCCESS"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS, className }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    // Emerald green color palette for Niraah branding
    const colors = [
      { r: 16, g: 185, b: 129 },   // Emerald primary
      { r: 52, g: 211, b: 153 },   // Emerald secondary
      { r: 110, g: 231, b: 183 },  // Light emerald
      { r: 6, g: 148, b: 94 },     // Dark emerald
    ]
