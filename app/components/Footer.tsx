  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          padding: '100px 24px',
          background: 'linear-gradient(to bottom, #000000 0%, #000000 50%, #f5f0e8 50%, #f5f0e8 100%)',
          minHeight: '60vh',
        }}
      >
        ...
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(ellipse at center bottom, #f5f0e8 0%, #f5f0e8 100%)',
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center flex flex-col h-full justify-center">
          ...
          >
            ...
            <motion.a
              ...
              className="inline-flex items-center justify-center bg-black text-white font-sans font-bold text-sm tracking-wider uppercase rounded-full transition-all hover:shadow-[0_10px_40px_rgba(16,185,129,0.3)]"
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            {/* Copyright / Credit */}
            <div className="flex flex-col items-center md:items-start gap-1 md:gap-2 font-sans text-sm font-medium text-[rgba(0,0,0,0.5)] text-center md:text-left">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-[rgba(0,0,0,0.5)] hover:text-black transition-colors" aria-label="Email">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            </a>
            <a href="#" className="text-[rgba(0,0,0,0.5)] hover:text-black transition-colors" aria-label="Twitter">
            ...
            <a href="#" className="text-[rgba(0,0,0,0.5)] hover:text-black transition-colors" aria-label="LinkedIn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
            </a>
            <a href="#" className="text-[rgba(0,0,0,0.5)] hover:text-black transition-colors" aria-label="Instagram">
