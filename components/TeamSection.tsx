    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6" style={{ color: '#0f2817' }}>
          ...
          <p className="text-lg max-w-3xl mx-auto" style={{ color: '#166534' }}>
            ...
            >
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-xl font-bold" style={{ color: '#16a34a' }}>{item.label}</div>
                </div>
              </div>
            </div>
          ))}
