...
interface NeuralBackgroundProps {
     ...
     * Defaults to yellow to match the Niraah brand.
     */
    color?: string;
    /**
    ...
    speed?: number;
    /**
     * Background color for the trail effect.
...
export default function NeuralBackground({
    className,
    color = "#FFC107", // Yellow to match Niraah brand
    trailOpacity = 0.08,
    particleCount = 600,
    speed = 1,
    ...
    useEffect(() => {
        ...
        class Particle {
            ...
            draw(context: CanvasRenderingContext2D) {
                ...
                context.fillRect(this.x, this.y, 2, 2); // Small dots
            }
        }
    ...
    return (
        <div ref={containerRef} className={cn("absolute inset-0 w-full h-full overflow-hidden pointer-events-none", className)}>
